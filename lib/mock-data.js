...
// Un vendedor representativo por cada una de las 9 regiones — para que el
// login demo del vendedor permita elegir región sin tener que mostrar los
// 23 vendedores completos.
export function oneVendorPerRegion() {
  const seen = new Set();
  const list = [];
